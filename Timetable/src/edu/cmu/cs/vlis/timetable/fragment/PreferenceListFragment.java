...
public class PreferenceListFragment extends ListFragment {
    ...
    public void onDestroyView() {
        ...
        if (p != null) ((ViewGroup) p).removeView(lv);
    }
     ...
     * <p>
     * Binding late is preferred as any custom preference types created in {@link #onCreate(Bundle)}
     * are able to have their views recycled.
     */
    ...
    public void addPreferencesFromResource(int preferencesResId) {
        try {
            ...
            m.setAccessible(true);
            PreferenceScreen prefScreen = (PreferenceScreen) m.invoke(mPreferenceManager,
